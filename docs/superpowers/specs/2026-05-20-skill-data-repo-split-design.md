...
1. Install `git-filter-repo` temporarily in a disposable virtual environment outside the repository.
2. Run the history rewrite.
3. Remove the temporary virtual environment after rewrite and verification.
